...
(defmethod hugsql.core/hugsql-result-fn :1 [sym]
  'orbis-grcmanager.db.core/result-one-snake->kebab)

(defmethod hugsql.core/hugsql-result-fn :* [sym]
  'orbis-grcmanager.db.core/result-many-snake->kebab)
...
(defn delete-all-logs-and-register! [{:keys [screenname] :as user}]
  (conman/with-transaction [*db*]
                           (delete-all-logs!)
                           (insert-log<!
                             {:id-user       1
                              :hostname-log  screenname
                              :resource-log  4
                              :severity-log  6
                              :message-log   "El log de auditoría ha sido eliminado"} )))