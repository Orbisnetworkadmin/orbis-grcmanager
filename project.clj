(defproject orbis-grcmanager "0.1.0"

  :description "Orbis GRC Manager"
  :url "http://www.orbisnetwork.com.ve"
  ...
  :main ^:skip-aot orbis-grcmanager.core
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "orbis-grcmanager.jar"
                   ...
                   {:test
                    {:source-paths ["src/cljc" "src/cljs" "test/cljs"]
                     ...
                     {:output-to "target/test.js"
                      :main "orbis_grcmanager.doo-runner"
